...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_08_NumberOfClasses : Noark5XmlReaderBaseTest
    {
        ...
        private N5_08_ArchivePart _currentArchivePart = new N5_08_ArchivePart();
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            {
                _currentArchivePart = new N5_08_ArchivePart();
            }
        }
        ...
        {
            public N5_08_ArchivePart ArchivePart { get; }
            public string ClassificationSystemId { get; }
            public Dictionary<int, int> ClassesPerLevel { get; }
            public bool Primary { get; set; }

            public ClassificationSystem(N5_08_ArchivePart currentArchivePart, string classificationSystemId)
            {
        ...
        public class N5_08_ArchivePart : ArchivePart { }
    }
}
