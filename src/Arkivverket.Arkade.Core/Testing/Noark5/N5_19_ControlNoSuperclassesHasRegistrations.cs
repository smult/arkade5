...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_19_ControlNoSuperclassesHasRegistrations : Noark5XmlReaderBaseTest
    {
        ...
        private N5_19_ArchivePart _currentArchivePart = new N5_19_ArchivePart();
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            if (eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_19_ArchivePart();
        }
        ...
        private class Class
        {
            ...
            public N5_19_ArchivePart ArchivePart { get; set; }
        ...
        private class N5_19_ArchivePart : ArchivePart {}
    }
}
