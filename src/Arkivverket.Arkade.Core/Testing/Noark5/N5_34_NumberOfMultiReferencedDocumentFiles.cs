...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_34_NumberOfMultiReferencedDocumentFiles : Noark5XmlReaderBaseTest
    {
        ...
        private N5_34_ArchivePart _currentArchivePart = new N5_34_ArchivePart();
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            if(eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_34_ArchivePart();
        }

        private class DocumentObject
        {
            public N5_34_ArchivePart ArchivePart { get; set; }
            public string FileReference { get; set; }
        }

        private class N5_34_ArchivePart : ArchivePart { }
    }
}
