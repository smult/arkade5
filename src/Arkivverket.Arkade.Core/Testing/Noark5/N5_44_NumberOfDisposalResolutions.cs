...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_44_NumberOfDisposalResolutions : Noark5XmlReaderBaseTest
    {
        ...
        private N5_44_ArchivePart _currentArchivePart = new N5_44_ArchivePart();
        private List<N5_44_ArchivePart> _archiveParts = new List<N5_44_ArchivePart>();
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            if (eventArgs.NameEquals("arkivdel"))
            {
                ...
                _currentArchivePart = new N5_44_ArchivePart();
            }
        }
        ...
        {
            public N5_44_ArchivePart ArchivePart { get; set; }
            public string ParentElementName { get; set; }
        }

        private class N5_44_ArchivePart : ArchivePart { }
    }
}
