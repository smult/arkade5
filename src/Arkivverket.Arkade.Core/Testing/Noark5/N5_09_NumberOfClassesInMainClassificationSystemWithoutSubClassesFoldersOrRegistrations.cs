...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
        ...
        : Noark5XmlReaderBaseTest
    {
        ...
        private N5_09_ArchivePart _currentArchivePart = new N5_09_ArchivePart();
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            if(eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_09_ArchivePart();
        }
        ...
        {
            public N5_09_ArchivePart Archivepart { get; }
            public string ClassificationSystemId { get; }
            public int NumberOfEmptyClasses { get; set; }
            public bool IsPrimary { get; set; }

            public ClassificationSystem(N5_09_ArchivePart archivePart, string classificationSystemId)
            {
        ...
        private class N5_09_ArchivePart : ArchivePart { }
    }
}
