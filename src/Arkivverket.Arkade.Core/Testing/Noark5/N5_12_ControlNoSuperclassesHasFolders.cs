...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_12_ControlNoSuperclassesHasFolders : Noark5XmlReaderBaseTest
    {
        ...
        private N5_12_ArchivePart _currentArchivePart = new N5_12_ArchivePart();
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            if (eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_12_ArchivePart(); // Reset
        }
        ...
        private class Class
        {
            ...
            public N5_12_ArchivePart ArchivePart { get; set; }
        ...
        private class N5_12_ArchivePart : ArchivePart { }
    }
}
