...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_43_NumberOfClassifications : Noark5XmlReaderBaseTest
    {
        ...
        private N5_43_ArchivePart _currentArchivePart = new N5_43_ArchivePart();
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            if(eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_43_ArchivePart();
        }
        ...
        {
            public N5_43_ArchivePart ArchivePart { get; set; }
            public string ParentElementName { get; set; }
        }

        private class N5_43_ArchivePart : ArchivePart { }
    }
}
