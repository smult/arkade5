...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_41_NumberOfDocumentFlows : Noark5XmlReaderBaseTest
    {
        ...
        private N5_41_ArchivePart _currentArchivePart = new N5_41_ArchivePart();
        private bool _journalPostAttributeIsFound;
        private readonly Dictionary<N5_41_ArchivePart, int> _documentFlowsPerArchivePart = new Dictionary<N5_41_ArchivePart, int>();
        ...
        protected override List<TestResult> GetTestResults()
        {
            ...
            {
                foreach (KeyValuePair<N5_41_ArchivePart, int> correspondancePartCount in _documentFlowsPerArchivePart)
                {
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            if(eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_41_ArchivePart();
        }

        private class N5_41_ArchivePart : ArchivePart { } 
    }
}
