...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_20_NumberOfRegistrationsPerClass : Noark5XmlReaderBaseTest
    {
        ...
        private N5_20_ArchivePart _currentArchivePart = new N5_20_ArchivePart();
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            {
                _currentArchivePart = new N5_20_ArchivePart();
            }
        }
        ...
        private class Class
        {
            ...
            public N5_20_ArchivePart ArchivePart { get; set; }
            public int NumberOfRegistrations { get; set; }
        }

        private class N5_20_ArchivePart : ArchivePart { }
    }
}
