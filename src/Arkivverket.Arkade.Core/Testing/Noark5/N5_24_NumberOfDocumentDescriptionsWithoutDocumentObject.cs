...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_24_NumberOfDocumentDescriptionsWithoutDocumentObject : Noark5XmlReaderBaseTest
    {
        ...
        private N5_24_ArchivePart _currentArchivePart = new N5_24_ArchivePart();
        private readonly Dictionary<N5_24_ArchivePart, int> _noDocumentObjectCountPerArchivePart = new Dictionary<N5_24_ArchivePart, int>();
        ...
        protected override List<TestResult> GetTestResults()
        {
            ...
            {
                foreach (KeyValuePair<N5_24_ArchivePart, int> noDocumentObjectCount in _noDocumentObjectCountPerArchivePart)
                {
