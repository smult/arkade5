...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_21_NumberOfRegistrationsWithoutDocumentDescription : Noark5XmlReaderBaseTest
    {
        ...
        private readonly Dictionary<N5_21_ArchivePart, int> _noDocumentDescriptionCountPerArchivepart = new Dictionary<N5_21_ArchivePart, int>();
        private N5_21_ArchivePart _currentArchivePart = new N5_21_ArchivePart();
        ...
        protected override List<TestResult> GetTestResults()
        {
            ...
            {
                foreach (KeyValuePair<N5_21_ArchivePart, int> noDocumentDescriptionCount in _noDocumentDescriptionCountPerArchivepart)
                {
