...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_39_NumberOfCorrespondenceParts : Noark5XmlReaderBaseTest
    {
        ...
        private N5_39_ArchivePart _currentArchivePart = new N5_39_ArchivePart();
        private readonly Dictionary<N5_39_ArchivePart, int> _correspondancePartsPerArchivePart = new Dictionary<N5_39_ArchivePart, int>();
        ...
        protected override List<TestResult> GetTestResults()
        {
            ...
            {
                foreach (KeyValuePair<N5_39_ArchivePart, int> correspondancePartCount in _correspondancePartsPerArchivePart)
                {
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            if (eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_39_ArchivePart();
        ...
        private class N5_39_ArchivePart : ArchivePart { }
    }
}
