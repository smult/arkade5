...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_23_NumberOfDocumentDescriptions : Noark5XmlReaderBaseTest
    {
        ...
        private N5_23_ArchivePart _currentArchivePart = new N5_23_ArchivePart();
        private int _totalNumberOfDocumentDescriptions;
        private readonly Dictionary<N5_23_ArchivePart, int> _documentDescriptionsPerArchivePart = new Dictionary<N5_23_ArchivePart, int>();
        ...
        protected override List<TestResult> GetTestResults()
        {
            ...
            {
                foreach (KeyValuePair<N5_23_ArchivePart, int> documentDescriptionCount in _documentDescriptionsPerArchivePart)
                {
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            if(eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_23_ArchivePart();
        }

        private class N5_23_ArchivePart : ArchivePart { }
    }
}