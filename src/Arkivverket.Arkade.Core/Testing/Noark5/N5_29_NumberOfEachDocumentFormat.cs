...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_29_NumberOfEachDocumentFormat : Noark5XmlReaderBaseTest
    {
        ...
        private N5_29_ArchivePart _currentArchivePart = new N5_29_ArchivePart();
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            if(eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_29_ArchivePart();
        }

        private class DocumentObject
        {
            public N5_29_ArchivePart ArchivePart { get; set; }
        ...
        private class N5_29_ArchivePart : ArchivePart { }
    }
}
