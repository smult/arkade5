...
namespace Arkivverket.Arkade.Core.Testing.Noark5
{
    public class N5_26_NumberOfDocumentObjects : Noark5XmlReaderBaseTest
    {
        ...
        private N5_26_ArchivePart _currentArchivePart = new N5_26_ArchivePart();
        private int _totalNumberOfDocumentObjects;
        private readonly Dictionary<N5_26_ArchivePart, int> _documentObjectsPerArchivePart = new Dictionary<N5_26_ArchivePart, int>();
        ...
        protected override List<TestResult> GetTestResults()
        {
            ...
            {
                foreach (KeyValuePair<N5_26_ArchivePart, int> documentObjectsCount in _documentObjectsPerArchivePart)
                {
        ...
        protected override void ReadEndElementEvent(object sender, ReadElementEventArgs eventArgs)
        {
            ...
            if(eventArgs.NameEquals("arkivdel"))
                _currentArchivePart = new N5_26_ArchivePart();
        }

        private class N5_26_ArchivePart : ArchivePart { }
    }
}